var movieQuestions = {
    questionTypes: [
        ...
        { id: 'cscore2', frequency: 1, choiceCount: 2, calculation: 'criticScore', order: 'desc', spread: 40, display: 'Which film has the HIGHER Tomatometer score?', correct: '{cname} has a score of {val}%', incorrect: '{iname} only scored {ival}%'},
        { id: 'ascore2', frequency: 1, choiceCount: 2, calculation: 'audienceScore', order: 'desc', spread: 40, display: 'Which film has the higher AUDIENCE score on Rotten Tomatoes?', correct: '{cname} has a score of {val}%', incorrect: '{iname} only scored {ival}%'},
        ...
        { id: 'quotes4', frequency: 1.5, choiceCount: 4, calculation: 'quotes', calculationType: 'list', minimum: 1, display: 'QUOTE: "{val}"', correct: 'The quote was from {cname}', incorrect: 'The quote was from {cname}'}
    ],
